...
def build_argparser():
    ...
    general.add_argument('-i', '--input', default=0,
    ...
    gallery.add_argument('-fg', default='face_user', help='Optional. Path to the face images directory.')
    ...
    models.add_argument('-m_fd', type=Path, default = 'face-detection-retail-0005.xml',
                        help='Required. Path to an .xml file with Face Detection model.')
    models.add_argument('-m_lm', type=Path, default = 'landmarks-regression-retail-0009.xml',
                        help='Required. Path to an .xml file with Facial Landmarks Detection model.')
    models.add_argument('-m_reid', type=Path, default = 'face-reidentification-retail-0095.xml',
...
# # Truyền các đối số từ argparse vào chương trình chính
# program_path = r'face_recognition_demo.py'
# command = f"python {program_path} -i 0 -fg face_user --allow_grow -m_fd {args.m_fd} -m_lm {args.m_lm} -m_reid {args.m_reid}"
# import subprocess
